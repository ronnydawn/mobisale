...
React.createElement("div", null, 
    ...
    React.createElement("div", {className: "navbar navbar-inverse navbar-fixed-top"}, 
        ...
        React.createElement("a", {className: "navbar-brand", href: "#"}, "Off Canvas Menu"), 
        React.createElement("div", {className: "navbar-header pull-right"}, 
          React.createElement("a", {id: "nav-expander", className: "nav-expander fixed"}, 
            "MENU  ", React.createElement("i", {className: "fa fa-bars fa-lg white"})
          )
        )
    ), 
