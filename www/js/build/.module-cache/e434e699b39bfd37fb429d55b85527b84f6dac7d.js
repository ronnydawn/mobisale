  ...
  render: function() {
    return (
        React.createElement("div", {id: "wrapper"}, 
                ...
                React.createElement("div", {className: "navbar-inverse", role: "navigation"}, 
                    React.createElement("div", {className: "container-fluid"}, 
                    React.createElement("div", {className: "row"}, 
                      React.createElement("div", {className: "col-xs-2"}, React.createElement("a", {href: "#menu-toggle", className: "btn btn-default", id: "menu-toggle"}, "X")), 
                      React.createElement("div", {className: "col-xs-8"}, ".col-xs-6 .col-md-4"), 
                      React.createElement("div", {className: "col-xs-2"}, ".col-xs-6 .col-md-4")
                    )
                    )
                ), 
