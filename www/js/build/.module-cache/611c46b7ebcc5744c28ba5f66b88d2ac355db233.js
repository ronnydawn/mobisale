				  ...
				  React.createElement("div", {className: "inner-wrap"}, 
				    React.createElement("nav", {className: "tab-bar"}, 
				      ...
				      React.createElement("section", {className: "middle tab-bar-section"}, 
				        React.createElement("h1", {className: "title"}, "Foundation")
				      ), 

				      React.createElement("section", {className: "right-small"}, 
				        React.createElement("a", {className: "right-off-canvas-toggle menu-icon", href: "#"}, React.createElement("span", null))
				      )
				    ), 
				    ...
				    React.createElement("aside", {className: "right-off-canvas-menu"}, 
				      React.createElement("ul", {className: "off-canvas-list"}, 
				        React.createElement("li", null, React.createElement("label", null, "Users")), 
				        React.createElement("li", null, React.createElement("a", {href: "#"}, "Hari Seldon")), 
				        React.createElement("li", null, React.createElement("a", {href: "#"}, "..."))
				      )
				    ), 
