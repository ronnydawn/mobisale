			...
			React.createElement("div", null, 
				React.createElement("nav", {className: "navbar-default navbar-static-top"}, 
				  React.createElement("div", {className: "container-fluid"}, 
				      			...
				      			React.createElement("button", {type: "button", className: "navbar-left btn btn-default navbar-btn glyphicon glyphicon-menu-hamburger"}), 
				      		
				      		
				      			React.createElement("button", {type: "button", className: "navbar-right btn btn-default navbar-btn glyphicon glyphicon-shopping-cart"}), 
				      		
		
				      			React.createElement("button", {type: "button", className: "navbar-right btn btn-default navbar-btn glyphicon glyphicon-search"})
