    ...
    return (
        React.createElement("div", {id: "wrapper"}, 
                ...
                React.createElement("nav", {className: "navbar navbar-inverse navbar-fixed-top", role: "navigation"}, 
                    React.createElement("ul", {className: "nav navbar-left top-nav"}, 
                    React.createElement("a", {href: "#menu-toggle", className: "btn btn-default", id: "menu-toggle"}, "Toggle Menu")
                    ), 
                    React.createElement("ul", {className: "nav navbar-right top-nav"}, 
                    "kanan"
                    )
                ), 
